...
namespace kxf::SevenZip::Private::Callback
{
	class ExtractArchive: public WithEvtHandler, public IArchiveExtractCallback, public ICryptoGetTextPassword, public ICryptoGetTextPassword2
	{
		...
		public:
			ExtractArchive(IEvtHandler* evtHandler = nullptr)
...
namespace kxf::SevenZip::Private::Callback
{
	class ExtractArchiveWrapper: public ExtractArchive
	{
		...
		public:
			ExtractArchiveWrapper(const IArchiveExtract& extract, Compression::IExtractCallback& callback, IEvtHandler* evtHandler = nullptr)
...
namespace kxf::SevenZip::Private::Callback
{
	class ExtractArchiveToFS: public ExtractArchiveWrapper, private Compression::IExtractCallback
	{
		...
		public:
			ExtractArchiveToFS(const IArchiveExtract& extract, IFileSystem& fileSystem, FSPath directory, IEvtHandler* evtHandler = nullptr)
...
namespace kxf::SevenZip::Private::Callback
{
	class ExtractArchiveToStream: public ExtractArchiveWrapper, private Compression::IExtractCallback
	{
		...
		public:
			ExtractArchiveToStream(const IArchiveExtract& extract, OutputStreamDelegate steram, IEvtHandler* evtHandler = nullptr)
